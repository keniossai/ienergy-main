...
$(".paginate").slice(0, 20).show();
$(".load").on("click", function () {
    $(".paginate:hidden").slice(0, 8).slideDown();
    if ($(".paginate:hidden").length == 0) {
        $("load").fadeOut("slow");
    }
});

$(".morenews").slice(0, 9).show();
$(".load").on("click", function () {
    $(".morenews:hidden").slice(0, 8).slideDown();
    if ($(".morenews:hidden").length == 0) {
        $("load").fadeOut("slow");
    }
});
